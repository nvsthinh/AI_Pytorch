...
class TorchRandomForestClassifier(torch.nn.Module):
    ...
    :class:`tree_based.binary_tree.TorchDecisionTreeClassifier` which are built during the :func:`fit` and called
    recursively during the :func:`predict`.

    Args:
        nb_trees (:class:`int`): Number of :class:`tree_based.binary_tree.TorchDecisionTreeClassifier` used to fit the
            classification problem.
        nb_samples (:class:`int`): Number of vector samples used to fit each
            :class:`tree_based.binary_tree.TorchDecisionTreeClassifier`.
    ...
    def fit(self, vectors, labels):
        ...
        :class:`tree_based.binary_tree.TorchDecisionTreeClassifier` to solve a specific classification problem.
    ...
    def predict(self, vector):
        ...
        :class:`tree_based.binary_tree.TorchDecisionTreeClassifier` to classify the vector.
...
class TorchRandomForestRegressor(torch.nn.Module):
    ...
    function which can be used with torch tensors. The random forest is based on
    :class:`tree_based.binary_tree.TorchDecisionTreeRegressor` which are built during the :func:`fit` and called
    recursively during the :func:`predict`.

    Args:
        nb_trees (:class:`int`): Number of :class:`tree_based.binary_tree.TorchDecisionTreeRegressor` used to fit the
            classification problem.
        nb_samples (:class:`int`): Number of vector samples used to fit each
            :class:`tree_based.binary_tree.TorchDecisionTreeRegressor`.
        max_depth (:class:`int`): The maximum depth which corresponds to the maximum successive number of
    ...
    def fit(self, vectors, values):
        """
        Function which must be used after the initialisation to fit the random forest and build the successive
        :class:`tree_based.binary_tree.TorchDecisionTreeRegressor` to solve a specific classification problem.
    ...
    def predict(self, vector):
        """
        Function which must be used after the the fitting of the random forest. It calls recursively the different
        :class:`tree_based.binary_tree.TorchDecisionTreeRegressor` to regress the vector.
