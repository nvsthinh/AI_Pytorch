...
from ..decision_tree.decision_tree import DecisionTreeClassifier, DecisionTreeRegressor
...
class RandomForestClassifier(torch.nn.Module):
    ...
    :class:`tree_based.binary_tree.DecisionTreeClassifier` which are built during the :func:`fit` and called
    recursively during the :func:`predict`.

    Args:
        nb_trees (:class:`int`): Number of :class:`tree_based.binary_tree.DecisionTreeClassifier` used to fit the
            classification problem.
        nb_samples (:class:`int`): Number of vector samples used to fit each
            :class:`tree_based.binary_tree.DecisionTreeClassifier`.
    ...
    def fit(self, vectors, labels):
        ...
        :class:`tree_based.binary_tree.DecisionTreeClassifier` to solve a specific classification problem.
    ...
    def predict(self, vector):
        ...
        :class:`tree_based.binary_tree.DecisionTreeClassifier` to classify the vector.
...
class RandomForestRegressor(torch.nn.Module):
    """
    Torch random forest object used to solve regression problem. This object implements the fitting and prediction
    function which can be used with torch tensors. The random forest is based on
    :class:`tree_based.binary_tree.DecisionTreeRegressor` which are built during the :func:`fit` and called
    recursively during the :func:`predict`.

    Args:
        nb_trees (:class:`int`): Number of :class:`tree_based.binary_tree.DecisionTreeRegressor` used to fit the
            classification problem.
        nb_samples (:class:`int`): Number of vector samples used to fit each
            :class:`tree_based.binary_tree.DecisionTreeRegressor`.
        max_depth (:class:`int`): The maximum depth which corresponds to the maximum successive number of
    ...
    def fit(self, vectors, values):
        """
        Function which must be used after the initialisation to fit the random forest and build the successive
        :class:`tree_based.binary_tree.DecisionTreeRegressor` to solve a specific classification problem.
    ...
    def predict(self, vector):
        """
        Function which must be used after the the fitting of the random forest. It calls recursively the different
        :class:`tree_based.binary_tree.DecisionTreeRegressor` to regress the vector.
